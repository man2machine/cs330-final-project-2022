...
def test_AutoEncoder():
    ...
    patch_size=4
    n_classes=10
    test_tensor = torch.randn(1, 3, 3,32,32) # we have sampled 16 frames from video with batch size of 1
    ...
    encoder = ViTMaskedVideoAutoEncoder(img_size=32, frames_depth=3, patch_size=patch_size, num_classes=n_classes, dim=192,
