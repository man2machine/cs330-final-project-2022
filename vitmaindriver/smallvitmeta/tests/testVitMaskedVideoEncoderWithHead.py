...
def test_AutoEncoder():
    ...
    test_tensor = torch.randn(4, 3, 16,64,64) # we have sampled 16 frames from video with batch size of 1
    ...
    encoder = ViTMaskedVideoEncoderWithHead(img_size=64, frames_depth=16, patch_size=patch_size, num_classes=n_classes, dim=192,
